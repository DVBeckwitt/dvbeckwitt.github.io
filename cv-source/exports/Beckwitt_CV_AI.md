...
Degree status: Ph.D. candidate, Physics, University of Missouri, expected July 2026
...
Date/status: expected July 2026
...
Focus: X-ray diffraction instrumentation, GIWAXS simulation, thin-film growth, physics-informed machine learning, and AI-assisted scientific-computing workflows.
...
- Commercial LLM product development or LLM application ownership.
- Production AI-agent deployment, production MLOps, or cloud deployment ownership.
- Formal prompt-engineering title or AI governance ownership.
- Unvalidated AI-generated research conclusions.
