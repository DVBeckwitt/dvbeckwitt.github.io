...
- Contact line follows the preferred order: David.Beckwitt@proton.me | linkedin.com/in/dvbeckwitt | github.com/DVBeckwitt | Columbia, MO.
- Resume has no `Target role:` header line unless David specifically asks for it.
...
- Every resume and cover-letter claim is supported by `data/cv_master.json`, the source CV, teaching documents, a user-provided update, or the job posting for employer needs.
- Requirements David has not directly met are listed in the evidence matrix as gaps.
...
- For analytics, data analyst, data science, technical analyst, or People Analytics roles, David is positioned as a quantitative Python analyst with a physics research background; the employer's domain is treated as target context, not prior experience.
...
- Example files were treated as style references only, not evidence sources.
- No stale example claims were copied unless independently supported by `data/cv_master.json` or a user-provided update.
