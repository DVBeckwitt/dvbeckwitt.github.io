...
title: Contact
description: >
  Contact information for David Beckwitt, including professional profiles,
  research links, and code repositories.
permalink: /contact/
menu: true
order: 6
---
...
| Academic background | [CV](/cv/) |
{:.stretch-table}

For research context, start with [Research](/research/).

For public repositories outside the main research program, start with [Projects](/projects/).
