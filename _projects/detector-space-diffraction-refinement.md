...
This is the central workflow behind my dissertation, _X-ray Diffraction Characterization and Simulation of 2D-Oriented Powders_. It is designed for layered films that are neither single crystals nor fully random powders. The layer normal can remain aligned to the substrate while in-plane orientation, mosaic spread, and stacking disorder create structured intensity across a two-dimensional detector.
